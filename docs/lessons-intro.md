...
* For newly-composed music like the examples from Jurassic Park, Dreamgirls, and Parasite, we might consider a [topical analysis](/lessons/topic-theory) or a [leitmotivic analysis](/lessons-leitmotif) to specify what is being suggested about the narrative through the music.
